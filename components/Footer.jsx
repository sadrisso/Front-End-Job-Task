    ...
    <div>
      <footer className="bg-gray-100 py-12 px-4 sm:px-6 lg:px-8 font-inter">
        <div className="max-w-7xl mx-auto">
          ...
          {/* Middle section - Download App and Accepted Payment Methods */}
          {/* Uses flexbox for horizontal layout on larger screens, stacks vertically on small screens */}
          <div className="flex flex-col md:flex-row justify-between items-center md:items-start gap-8 mb-12 border-t border-gray-200 pt-8">
            {/* Download App */}
            <div className="text-center md:text-left">
              <h4 className="text-lg font-semibold text-gray-800 mb-4">
                Download App:
                ...
                <a href="#" className="inline-block">
                  <img
                    ...
                    onError={(e) => {
                      ...
                      e.target.src =
                        "https://placehold.co/120x40/000000/FFFFFF?text=App+Store";
                    }}
                  />
                </a>
                {/* Google Play button */}
                <a href="#" className="inline-block">
                  <img
                    ...
                    onError={(e) => {
                      e.target.onerror = null;
                      e.target.src =
                        "https://placehold.co/120x40/000000/FFFFFF?text=Google+Play";
                    }}
                  />
                </a>
              </div>
              ...
              <div className="flex gap-4 justify-center md:justify-end">
                ...
                <img
                  ...
                  onError={(e) => {
                    e.target.onerror = null;
                    e.target.src =
                      "https://placehold.co/60x40/F0F0F0/000000?text=VISA";
                  }}
                />
                {/* PayPal icon */}
                <img
                  ...
                  onError={(e) => {
                    e.target.onerror = null;
                    e.target.src =
                      "https://placehold.co/60x40/F0F0F0/000000?text=PayPal";
                  }}
                />
                {/* Apple Pay icon */}
                <img
                  ...
                  onError={(e) => {
                    e.target.onerror = null;
                    e.target.src =
                      "https://placehold.co/60x40/F0F0F0/000000?text=ApplePay";
                  }}
                />
              </div>
            </div>
